/**
 * 管理中心 CRUD：数据持久化在 business 模块 data/demo/*.json。
 */
const MockCrudRegistry = (function () {
    const API_STORAGE_PATH = '/business/api/business/storage-path';
    ...
    const CONFIGS = {
        company: {
            title: '公司管理',
            hint: '数据保存在 business 数据目录 data/demo/companies.json',
            apiBase: '/business/api/companies',
        ...
        department: {
            ...
            apiBase: '/business/api/departments',
        ...
        userMgmt: {
            ...
            apiBase: '/business/api/admin/users',
            dataFile: 'users.json',
            idField: 'id',
            columns: [
                { key: 'id', label: 'ID', width: '60px' },
        ...
        orderMgmt: {
            ...
            apiBase: '/business/api/admin/orders',
